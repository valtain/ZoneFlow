...
| # | 제목 | 상태 |
| --- | --- | --- |
| 1 | Dungeon 씬 5-Zone 선형 체인 시연 — dungeon_0~dungeon_4(0↔1↔2↔3↔4). 진입 Zone `dungeon`→`dungeon_0` rename(Overworld portal·ColdStartup·GamePlayNavigationTests·SceneSetupTool 참조 갱신) + 카탈로그 re-bake. 같은 씬 내 Zone 이동 시 씬 언로드 없음 시연 | #74 closed |
